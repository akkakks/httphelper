...
var hostPortHandler = HandlerFunc(func(w ResponseWriter, r *http.Request) {
...
func TestTransportReadToEndReusesConn(t *testing.T) {
	...
	ts := httptest.NewServer(HandlerFunc(func(w ResponseWriter, r *http.Request) {
...
func TestRoundTripGzip(t *testing.T) {
	...
	ts := httptest.NewServer(HandlerFunc(func(rw ResponseWriter, req *http.Request) {
...
func TestTransportProxy(t *testing.T) {
	...
	defer ts.Close()
	proxy := httptest.NewServer(HandlerFunc(func(w ResponseWriter, r *http.Request) {
...
func TestIssue4191_InfiniteGetTimeout(t *testing.T) {
	...
	const debug = false
	mux := NewServeMux()
	mux.HandleFunc("/get", func(w ResponseWriter, r *http.Request) {
...
func TestIssue4191_InfiniteGetToPutTimeout(t *testing.T) {
	...
	mux.HandleFunc("/put", func(w ResponseWriter, r *http.Request) {
		defer r.Body.Close()
...
func TestTransportResponseHeaderTimeout(t *testing.T) {
	...
	mux := NewServeMux()
	mux.HandleFunc("/fast", func(w ResponseWriter, r *http.Request) {
		inHandler <- true
	})
	mux.HandleFunc("/slow", func(w ResponseWriter, r *http.Request) {
		inHandler <- true
...
func TestTransportSocketLateBinding(t *testing.T) {
	...
	mux.HandleFunc("/foo", func(w ResponseWriter, r *http.Request) {
		w.Header().Set("foo-ipport", r.RemoteAddr)
		w.(Flusher).Flush()
		<-fooGate
	})
	mux.HandleFunc("/bar", func(w ResponseWriter, r *http.Request) {
...
func TestTLSServerClosesConnection(t *testing.T) {
	...
	ts := httptest.NewTLSServer(HandlerFunc(func(w ResponseWriter, r *http.Request) {
